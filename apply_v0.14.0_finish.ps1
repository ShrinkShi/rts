...
$DeleteList = Join-Path $ProjectRoot "V0.14.0_FILES_TO_DELETE.txt"
$removed = 0
...
if (Test-Path -LiteralPath $GodotCache) { Remove-Item -LiteralPath $GodotCache -Recurse -Force }
Write-Host "v0.14.0 增量补丁清理完成。"
